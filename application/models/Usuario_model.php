...
class Usuario_model extends CI_Model{
	...
	function autenticar($usuario, $senha){
        $query="SELECT usuario.id, pessoa.nome,pessoa.rg, pessoa.cpf, usuario.pessoa_id, pessoa.foto,
	...
	* @return $usuario
	...
	function buscar_perfil($pessoa_id){
		$query="SELECT u.id, p.nome,p.rg, p.cpf,e.email,p.foto, p.id as pessoa_id, p.foto
	...
	function buscar_curso_por_coordenador($pessoa_id){
		$this->db->select("c.titulo as curso, c.id as curso_id")
		->FROM("curso c")
